...
#ifdef _WIN32
DWORD WINAPI teset_mt(LPVOID param)
#else
void * teset_mt(void * param)
#endif
{
...
int main(int argc, char ** argv)
{
    ...
    for (int thread_idx = 0; thread_idx < BALLER_THREAD_COUNT; ++thread_idx) {
        thread_handle.push_back(::CreateThread(0, 0, teset_mt, &thread_param, 0, 0));
    }
    ...
    for (int thread_idx = 0; thread_idx < BALLER_THREAD_COUNT; ++thread_idx) {
        ...
        pthread_create(&sub_handle, 0, teset_mt, &thread_param);
